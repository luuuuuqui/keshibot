...
# Script para reset da autenticação do Keshi Bot
# Versão: 0.9.0-BETA

echo "🤖 Keshi Bot - Reset da Autenticação"
echo "====================================="
echo ""

if [ ! -d "assets" ]; then
    echo "❌ Erro: Você deve executar este script no diretório raiz do Keshi Bot"
